        ...
        <div className="row mx-auto">
            <div className="row" id='cards'>
                <div className="card col-lg-3 my-2 p-3 shadow-sm border-0" style={cardmargin}>
                    <div className="card-text px-1"><i className='material-icons border border-light bg-light p-1 rounded-circle' style={{transform:"translateY(7px)",color:"orangered"}} width={25}>credit_card</i></div>
                    <div className="card-text px-1 mt-2 fw-bold" style={cardStyle}>We’ll give you a free debit card. Order it right in the app.</div>
                </div>
                <div className="card col-lg-3 my-2 p-3 shadow-sm border-0" style={cardmargin}>
                    <div className="card-text px-1"><i className='material-icons bg-light border border-light p-1 rounded-circle' style={{transform:"translateY(7px)",color:"orangered"}} width={25}>payments</i></div>
                ...
                <div className="card col-lg-3 my-2 p-3 shadow-sm border-0" style={cardmargin}>
                    <div className="card-text px-1"><i className='material-icons bg-light border border-light p-1 rounded-circle' style={{transform:"translateY(7px)",color:"orangered"}} width={25}>savings</i></div>
            ...
            <div className="mt-4 row" id='cardss'>
                <div className="card col-lg-3 my-2 p-3 shadow-sm border-0" style={cardmargin}>
                    <div className="card-text px-1"><i className='material-icons border border-light bg-light p-1 rounded-circle' style={{transform:"translateY(7px)",color:"orangered"}} width={25}>add_card</i></div>
                    <div className="card-text px-1 mt-2 fw-bold" style={cardStyle}>Pay absolutely nothing for sending money.</div>
                </div>
                <div className="card col-lg-3 my-2 p-3 shadow-sm border-0" style={cardmargin}>
                    <div className="card-text px-1"><i className='material-icons bg-light border border-light p-1 rounded-circle' style={{transform:"translateY(7px)",color:"orangered"}} width={25}>attach_money</i></div>
